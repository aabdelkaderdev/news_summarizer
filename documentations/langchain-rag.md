[Skip to main content](https://docs.langchain.com/oss/python/langchain/rag#content-area)
...
- [Get help](https://docs.langchain.com/oss/python/langchain/get-help)

On this page

- [Overview](https://docs.langchain.com/oss/python/langchain/rag#overview)
- [Concepts](https://docs.langchain.com/oss/python/langchain/rag#concepts)
- [Preview](https://docs.langchain.com/oss/python/langchain/rag#preview)
- [Setup](https://docs.langchain.com/oss/python/langchain/rag#setup)
- [Installation](https://docs.langchain.com/oss/python/langchain/rag#installation)
- [LangSmith](https://docs.langchain.com/oss/python/langchain/rag#langsmith)
- [Components](https://docs.langchain.com/oss/python/langchain/rag#components)
- [1\. Indexing](https://docs.langchain.com/oss/python/langchain/rag#1-indexing)
- [Loading documents](https://docs.langchain.com/oss/python/langchain/rag#loading-documents)
- [Splitting documents](https://docs.langchain.com/oss/python/langchain/rag#splitting-documents)
- [Storing documents](https://docs.langchain.com/oss/python/langchain/rag#storing-documents)
- [2\. Retrieval and generation](https://docs.langchain.com/oss/python/langchain/rag#2-retrieval-and-generation)
- [RAG agents](https://docs.langchain.com/oss/python/langchain/rag#rag-agents)
- [RAG chains](https://docs.langchain.com/oss/python/langchain/rag#rag-chains)
- [Next steps](https://docs.langchain.com/oss/python/langchain/rag#next-steps)

## [​](https://docs.langchain.com/oss/python/langchain/rag\#overview)  Overview
...
1. A RAG [agent](https://docs.langchain.com/oss/python/langchain/rag#rag-agents) that executes searches with a simple tool. This is a good general-purpose implementation.
2. A two-step RAG [chain](https://docs.langchain.com/oss/python/langchain/rag#rag-chains) that uses just a single LLM call per query. This is a fast and effective method for simple queries.

### [​](https://docs.langchain.com/oss/python/langchain/rag\#concepts)  Concepts
...
The indexing portion of this tutorial will largely follow the [semantic search tutorial](https://docs.langchain.com/oss/python/langchain/knowledge-base).If your data is already available for search (i.e., you have a function to execute a search), or you’re comfortable with the content from that tutorial, feel free to skip to the section on [retrieval and generation](https://docs.langchain.com/oss/python/langchain/rag#2-retrieval-and-generation)

### [​](https://docs.langchain.com/oss/python/langchain/rag\#preview)  Preview
...
## [​](https://docs.langchain.com/oss/python/langchain/rag\#setup)  Setup

### [​](https://docs.langchain.com/oss/python/langchain/rag\#installation)  Installation
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#langsmith)  LangSmith
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#components)  Components
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#loading-documents)  Loading documents
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#splitting-documents)  Splitting documents
...
**Go deeper**`TextSplitter`: Object that splits a list of [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) objects into smaller
...
## [​](https://docs.langchain.com/oss/python/langchain/rag\#2-retrieval-and-generation)  2\. Retrieval and generation
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#rag-agents)  RAG agents
...
### [​](https://docs.langchain.com/oss/python/langchain/rag\#rag-chains)  RAG chains

In the above [agentic RAG](https://docs.langchain.com/oss/python/langchain/rag#rag-agents) formulation we allow the LLM to use its discretion in generating a [tool call](https://docs.langchain.com/oss/python/langchain/models#tool-calling) to help answer user queries. This is a good general-purpose solution, but comes with some trade-offs:
...
The above [RAG chain](https://docs.langchain.com/oss/python/langchain/rag#rag-chains) incorporates retrieved context into a single system message for that run.As in the [agentic RAG](https://docs.langchain.com/oss/python/langchain/rag#rag-agents) formulation, we sometimes want to include raw source documents in the application state to have access to document metadata. We can do this for the two-step chain case by:
...
## [​](https://docs.langchain.com/oss/python/langchain/rag\#next-steps)  Next steps
...
- Deploy your application with [LangSmith Deployment](https://docs.langchain.com/langsmith/deployments)
...
\\
Previous](https://docs.langchain.com/oss/python/langchain/knowledge-base) [Build a SQL agent\\
\\
Next](https://docs.langchain.com/oss/python/langchain/sql-agent)

Ctrl+I

![index_diagram](https://mintcdn.com/langchain-5e9cc07a/I6RpA28iE233vhYX/images/rag_indexing.png?w=840&fit=max&auto=format&n=I6RpA28iE233vhYX&q=85&s=1838328a870c7353c42bf1cc2290a779)

![retrieval_diagram](https://mintcdn.com/langchain-5e9cc07a/I6RpA28iE233vhYX/images/rag_retrieval_generation.png?w=840&fit=max&auto=format&n=I6RpA28iE233vhYX&q=85&s=67fe2302e241fc24238a5df1cf56573d)